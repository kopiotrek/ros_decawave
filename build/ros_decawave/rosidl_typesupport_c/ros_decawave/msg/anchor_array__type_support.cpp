...
static const _AnchorArray_type_support_symbol_names_t _AnchorArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_decawave, msg, AnchorArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_decawave, msg, AnchorArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_decawave, msg, AnchorArray)() {
  return &::ros_decawave::msg::rosidl_typesupport_c::AnchorArray_message_type_support_handle;
}
