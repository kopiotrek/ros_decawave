...
ros_decawave__msg__Acc__init(ros_decawave__msg__Acc * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ros_decawave__msg__Acc__fini(msg);
    return false;
  }
  // x
  // y
...
ros_decawave__msg__Acc__create()
{
  ...
  ros_decawave__msg__Acc * msg = (ros_decawave__msg__Acc *)allocator.allocate(sizeof(ros_decawave__msg__Acc), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_decawave__msg__Acc));
  bool success = ros_decawave__msg__Acc__init(msg);
  if (!success) {
...
ros_decawave__msg__Acc__Sequence__init(ros_decawave__msg__Acc__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_decawave__msg__Acc * data = NULL;

  if (size) {
    data = (ros_decawave__msg__Acc *)allocator.zero_allocate(size, sizeof(ros_decawave__msg__Acc), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_decawave__msg__Acc__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_decawave__msg__Acc__fini(&data[i - 1]);
      }
...
ros_decawave__msg__Acc__Sequence__fini(ros_decawave__msg__Acc__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_decawave__msg__Acc__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_decawave__msg__Acc__Sequence * array = (ros_decawave__msg__Acc__Sequence *)allocator.allocate(sizeof(ros_decawave__msg__Acc__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_decawave__msg__Acc__Sequence__init(array, size);
  if (!success) {
...
ros_decawave__msg__Acc__Sequence__destroy(ros_decawave__msg__Acc__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_decawave__msg__Acc__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_decawave__msg__Acc__Sequence__are_equal(const ros_decawave__msg__Acc__Sequence * lhs, const ros_decawave__msg__Acc__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_decawave__msg__Acc__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_decawave__msg__Acc__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_decawave__msg__Acc);
    ros_decawave__msg__Acc * data =
      (ros_decawave__msg__Acc *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_decawave__msg__Acc__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ros_decawave__msg__Acc__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros_decawave__msg__Acc__copy(
